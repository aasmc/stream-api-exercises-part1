...
public class Exercise16 {
    ...
    public static void main(String[] args) {
        ...
        var countryCityStatistics = worldDao.findAllCountries()
                .stream()
                .collect(Collectors.groupingBy(Country::getName, Collector.of(CountryCitySummaryStatistics::new, accumulator, combiner)));
